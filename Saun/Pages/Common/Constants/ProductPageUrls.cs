...
namespace Pages.Common.Constants
{
    public static class ProductPagesUrls
    {
        ...
        public static string Inventory => "/Products/Inventory";
        public static string Products => "/Products/Products";
        public static string ProductTypes => "/ProductTypes";
        public static string ProductCategories => "/Products/ProductCategories";
        public static string Batches => "/Products/Batches";
